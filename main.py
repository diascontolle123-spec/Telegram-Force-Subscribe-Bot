...
GET_KEY_URL = "https://exe.io/GetkeyNinja-Samurai"
STATUS_TEXT = "AKTIF"
...
MAX_DEVICE_TEXT = "15/50 Max"
MANUAL_EXPIRY_TEXT = "22 September 17.30"
...
def build_application(settings: Settings) -> Application:
    ...
    application.add_handler(CommandHandler("listprice", list_harga))
    application.add_handler(MessageHandler(filters.Regex("^📊 List Price$"), list_harga))
